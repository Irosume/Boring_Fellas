...
<body class="bg-secondary">
    ...
    <nav class="navbar navbar-expand-sm bg-black fixed-top">
      <div class="container-fluid">
        ...
        <ul class="navbar-nav text-white">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="alumni_admin.php">Data Alumni</a>
          </li>
  ...
  <div class="container h-100 d-flex flex-column justify-content-center align-items-center ">
    <table class="table table-hover">
      ...
      $sql = "SELECT * FROM identitas_alumni JOIN jurusan ON identitas_alumni.id_jurusan = jurusan.id_jurusan";
      ...
      ?>
          ...
          <tr class="align-middle">
            ...
            <td class="fw-bold"><?php echo $row['tanggal_lahir']; ?></td>
            <td class="fw-bold"><?php echo $row['nama_jurusan']; ?></td>
            <td class="fw-bold"><?php echo $row['sosial_media']; ?></td>
            <td class="fw-bold"><?php echo $row['prestasi']; ?></td>
