    ...
    if ($tipe_gambar == "image/jpeg" || $tipe_gambar == "image/png") {
        if ($ukuran_gambar <= 1000000) {
            if (move_uploaded_file($tmp_gambar, $path)){
                ...
                $sql = "INSERT INTO identitas_alumni (id_alumni, nama_alumni, nisn, tanggal_lahir, id_jurusan, sosial_media, prestasi, id_aktivitas, nama_gambar, ukuran_gambar, tipe_gambar) VALUES (NULL, '$nama_alumni', '$nisn', '$date', '$jurusan', '$sosmed', '$prestasi', '$aktivitas', '$nama_gambar', '$ukuran_gambar', '$tipe_gambar')";
                var_dump($sql);
